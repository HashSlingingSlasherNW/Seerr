                          ...
                          <Link
                            ...
                            className={`flex items-center rounded-md px-2 py-2 text-base font-medium leading-6 transition duration-150 ease-in-out focus:outline-none ${
                              router.pathname.match(sidebarLink.activeRegExp)
                                ? 'bg-black/20 text-[#0b1f15] font-bold shadow-inner'
                                : 'text-[#0b1f15]/80 hover:bg-black/10 hover:text-[#0b1f15] focus:bg-black/10'
                            } `}
                ...
                {SidebarLinks.filter((link) =>
                  ...
                  return (
                    <Link
                      ...
                      href={sidebarLink.href}
                      as={sidebarLink.as}
                      className={`group flex items-center rounded-md px-2 py-2 text-lg font-medium leading-6 transition duration-150 ease-in-out focus:outline-none sidebar-nav-item ${
                        router.pathname.match(sidebarLink.activeRegExp)
                          ? 'bg-black/20 text-[#0b1f15] font-bold shadow-inner'
                          : 'text-[#0b1f15]/80 hover:bg-black/10 hover:text-[#0b1f15] focus:bg-black/10'
                      } `}
                          ...
                          <div className="ml-auto flex">
                            <Badge
                              className={`rounded-md ${
                                router.pathname.match(sidebarLink.activeRegExp)
                                  ? 'border-[#0b1f15]/30 bg-[#0b1f15]/20 !text-[#0b1f15]'
                                  : 'border-[#0b1f15]/20 bg-[#0b1f15]/10 !text-[#0b1f15]'
                              }`}
                            >
                              {pendingRequestsCount}
                            </Badge>
